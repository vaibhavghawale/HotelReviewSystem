...
//			users.setRatings(ratingUserList);
	...
	public User getUser(String userId) {
		...
		* Fetch the Rating for above user from Rating Micro-service for that we going to RestTemplate or feign client
...
////					Hotel hotel =forEntity.getBody(); 
		   ...
		   //<!-- Using ***FEIGN CLEINT   we are going to call http client and get data from other Micro-services -------------------->
				...
				return user;
		    	  ...
		    	  //<!-- Using *** FEIGN CLIENT   we are going to call http client and get data from other Micro-services -------------------->
